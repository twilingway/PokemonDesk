...
const Parallax = () => {
  ...
  return (
    <div className={s.root}>
      ...
      <div className={s.cloud} style={{ transform: `translate(${screenY * 0.02}px, ${screenX * 0.02}px)` }}>
      ...
      <div className={s.pokeBall} style={{ transform: `translate(${screenY * 0.04}px, ${screenX * 0.04}px)` }}>
        <img src={PokeBallPng} alt="Big PokeBall" />
      </div>
      <div className={s.pikachu} style={{ transform: `translate(${screenY * 0.05}px, ${screenX * 0.05}px)` }}>
